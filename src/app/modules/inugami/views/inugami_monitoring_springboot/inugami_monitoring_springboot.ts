...
@Component({
    templateUrl: './inugami_monitoring_springboot.html'
})
export class InugamiMonitoringSpingbootView  implements  OnInit {
    ...
    **************************************************************************/
    ...
    ngOnInit(): void {
        this.googleAnalytics.pageView("/inugami/inugami_monitoring_springboot");
        this.httpService.getSourceCode("data/inugami.xml").then(data=> this.initData(data));
        this.httpService.getSourceCode("data/inugami_monitoring_springboot/source_code.xml").then(data=> this.initData(data));
