...
@Component({
    templateUrl: './inugami_monitoring_springboot_activemq.html'
})
export class InugamiMonitoringSpringbootActivemqView  implements  OnInit {
    ...
    **************************************************************************/
    ...
    ngOnInit(): void {
        this.googleAnalytics.pageView("/inugami/inugami_monitoring_springboot_activemq");
        this.httpService.getSourceCode("data/inugami.xml").then(data=> this.initData(data));
        this.httpService.getSourceCode("data/inugami_monitoring_springboot_activemq/source_code.xml").then(data=> this.initData(data));
